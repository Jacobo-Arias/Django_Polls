...
class QuestionIndexViewTests(TestCase):
    ...
    def test_past_question(self):
        ...
        create_choice(choice_text='hola',question = q)
        response = self.client.get(reverse('polls:index'))
    ...
    def test_future_question_and_past_question(self):
        ...
        """
        q = create_question(question_text="Past question.", days=-30)
        create_choice(choice_text="Choice",question=q)
    ...
    def test_two_past_questions(self):
        ...
        create_choice(choice_text='hola mundo',question=q)
    ...
    def teste_two_future_questions(self):
        """
        The wuestion index page may display none questions"
        """
    ...
    def test_questions_with_choices(self):
        """
            Solo retornara las questions con choices
        """
        q = create_question(question_text="Question with choices", days = -1)
        create_choice(choice_text='hihi',question=q)
        create_question(question_text="Question with no choices", days = -1)
        response = self.client.get(reverse("polls:index"))
        self.assertQuerysetEqual(
            response.context['latest_question_list'],
